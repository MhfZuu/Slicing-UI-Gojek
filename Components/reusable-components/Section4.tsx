    ...
    return (
        <div className="text-black bg-white w-full flex flex-col items-center py-12 lg:py-20">
            <div className="mb-10 lg:mb-14">
                <h1 className="text-3xl lg:text-4xl font-maisonext-xbold">Join the ride</h1>
            </div>
                    ...
                    return (
                        <div className="space-y-3">
                            ...
                            <div className="space-y-1">
                                <h1 className="font-maison-bold text-2xl">{content.headline}</h1>
                                <p className="text-[15px] lg:text-base font-maison-book">{content.desc}</p>
                            </div>
                            <div>
                                <button className="rounded-3xl bg-[#00880d] w-fit py-3 px-4 text-base text-white font-maison-demi"> 
                                    Join as employee
                                </button>
                            </div>
                        </div>
